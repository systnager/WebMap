...
map.attributionControl.addAttribution('&copy; MapTiler&copy; OpenStreetMap contributors');
...
//                 if ()
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.former_owner_name}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.former_owner_name}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.parcel_number}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.parcel_number}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.cadnum}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.cadnum}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Орендар: </b> ${selected_layer.feature.properties.lessee}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lessee}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lessee}', this.id)"></i></th>
            </tr>
            <tr>
	...
	color: blue;">${selected_layer.feature.properties.lessee_code}</a></th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lessee_code}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lessee_code}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Договір оренди: </b>${selected_layer.feature.properties.lease_agreement_num}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lease_agreement_num}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lease_agreement_num}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lease_start_date}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lease_start_date}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lease_expiration_date}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lease_expiration_date}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Строк дії: </b>${selected_layer.feature.properties.lease_duration}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.lease_duration}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.lease_duration}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>НГО: </b>${selected_layer.feature.properties.normative_assesment_value}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.normative_assesment_value}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.normative_assesment_value}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Орендна плата: </b>${selected_layer.feature.properties.rent_value}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.rent_value}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.rent_value}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.rent_percent}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.rent_percent}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.collective_farm_name}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.collective_farm_name}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.administrative_unit_name}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.administrative_unit_name}', this.id)"></i></th>
            </tr>
            <tr>
            ...
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.parcel_fraction}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.parcel_fraction}', this.id)"></i></th>
            </tr>
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Примітка: </b>${selected_layer.feature.properties.notes}</th>
            <th><i class="fa fa-clone" id="copy_${selected_layer.feature.properties.notes}" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.notes}', this.id)"></i></th>
            </tr>
                <table >`
                break
            default:
